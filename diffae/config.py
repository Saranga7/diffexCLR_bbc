...
class TrainConfig(BaseConfig):
    ...
    def make_dataset(self, path=None, split = None, **kwargs):
        ...
        elif self.data_name == 'bbc021_simple_selective':
            return Selective_BBC_Dataset(path=path or self.data_path,
                                  img_size=self.img_size, split = split, **kwargs)
